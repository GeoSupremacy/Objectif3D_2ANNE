...
public:
    ...
    virtual std::string Registre() const = 0;
};
/**
...
public:
    ...
    std::string Registre()const override
    {
        return " Leaf " + std::to_string(value);
    }
};
/**
...
void ClientCode(Component* component) {
    ...
    std::cout << "Registre: " << component->Registre() << std::endl;
}
...
void ClientCode2(Component* component1, Component* component2) {
    ...
    std::cout << "Registre: " << component1->Registre() << std::endl;
}
