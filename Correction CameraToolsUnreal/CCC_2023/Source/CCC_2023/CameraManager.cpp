...
void UCameraManager::SpawnCameraFollow(FString _id, AActor* _target)
{
	SpawnCamera<ACameraFollow>(camerafollowDefault, _id, _target);
}

void UCameraManager::SpawnCameraOrbit(FString _id, AActor* _target)
{
	SpawnCamera<AOrbitCamera>(cameraOrbitDefault, _id, _target);
}
